...
class ZetaTest extends munit.CatsEffectSuite {
  ...
  private val table = BQTableDef.Table(
    BQTableId.unsafeOf(BQDataset.Ref.unsafeOf(ProjectId("com-example"), "example"), "test"),
    BQSchema.of(
  ...
  private val table2 = BQTableDef.Table(
    BQTableId.unsafeOf(BQDataset.Ref.unsafeOf(ProjectId("com-example"), "example"), "test2"),
    BQSchema.of(
      BQField("partitionDate", BQField.Type.DATE, BQField.Mode.REQUIRED),
  ...
  private val tvf = TVF(
    TVF.TVFId(BQDataset.Ref.unsafeOf(ProjectId("com-example"), "example"), ident"tvftest"),
